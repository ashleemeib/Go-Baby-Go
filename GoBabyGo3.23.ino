...
//Pins
#define EVI 13
#define KX134_SLAVE_ADDR_1F 0x1F // I2C address of KX134 accelerometer
#define KX134_DRDY_PIN 14        // interrupt-capable pin connected to DRDY pin of KX134
KX134 kxAccel(KX134_SLAVE_ADDR_1F); // create a KX134 object with the correct I2C address
...
void setup()
{
  ...
  // Initialize the accelerometer and set up the DRDY interrupt pin
  kxAccel.init(KX134_RANGE_2G, KX134_ODR_50); // initialize the KX134 accelerometer
  attachInterrupt(digitalPinToInterrupt(KX134_DRDY_PIN), kx134_isr, FALLING); // attach the interrupt function to the interrupt pin
